    ...
    <div className="h-[100dvh] w-full flex flex-col items-center justify-center p-8 bg-zinc-50 dark:bg-black overflow-hidden relative">
      ...
      <div className="max-w-md w-full relative z-10 space-y-16 animate-in fade-in slide-in-from-bottom-8 duration-1000">
        <div className="text-center space-y-4">
          ...
          <h2 className="text-3xl sm:text-5xl font-black text-zinc-900 dark:text-white tracking-[-0.05em] uppercase break-words">Executive Access</h2>
          <p className="text-[10px] font-black uppercase tracking-[0.6em] text-zinc-400">Identity Provisioning Layer</p>
        </div>

        <div className="space-y-10">
          {error && (
            <div className="bg-white dark:bg-zinc-900 border-2 border-black dark:border-white text-black dark:text-white p-6 rounded-[2rem] text-[9px] font-black uppercase tracking-widest flex items-center gap-4 animate-in shake">
